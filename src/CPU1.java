...
//            Process proc = rt.exec("java Memory1");
//            Process proc = rt.exec("java Memory1 "+fileName);
...
//            fileNameToMemory(pw, fileName);
            ...
            while (true)
            {
                ...
                int value = readFromMemory(pw, memory_reader, PC);
    ...
    */
    private static void fileNameToMemory(PrintWriter pw, String fileName) 
    {
    ...
    private static int readFromMemory(PrintWriter pw, Scanner memory_reader, int address) 
    {
    ...
    private static void processInstruction(int value, PrintWriter pw, InputStream is, Scanner memory_reader, OutputStream os) 
    {
        ...
        switch(IR)
        {
            case 1: //Load the value into the AC
                ...
                operand = readFromMemory(pw, memory_reader, PC);
                AC = operand;
            ...
            case 2: // Load the value at the address into the AC
                PC++;
                operand = readFromMemory(pw, memory_reader, PC);
                AC = readFromMemory(pw, memory_reader, operand);
                if(processingInterrupt == false) 
                    num_of_instructions++;
                PC++;
                break;
            ...
            case 3: // Load the value from the address found in the address into the AC
                PC++;
                operand = readFromMemory(pw, memory_reader, PC);
                operand = readFromMemory(pw, memory_reader, operand);
                AC = readFromMemory(pw, memory_reader, operand);
                if(processingInterrupt == false) 
                    num_of_instructions++;
                PC++;
            ...
            case 4: // Load the value at (address+X) into the AC
                PC++;
                operand = readFromMemory(pw, memory_reader, PC);
                AC = readFromMemory(pw, memory_reader, operand + X);
                if(processingInterrupt == false) 
                    num_of_instructions++;
                PC++;
                break;
            ...
            case 5: //Load the value at (address+Y) into the AC
                PC++;
                operand = readFromMemory(pw, memory_reader, PC);
                AC = readFromMemory(pw, memory_reader, operand + Y);
                if(processingInterrupt == false) 
                    num_of_instructions++;
                PC++;
                break;
            ...
            case 6: //Load from (Sp+X) into the AC
                AC = readFromMemory(pw, memory_reader, SP + X);
                if(processingInterrupt == false) 
                    num_of_instructions++;
                PC++;
                break;
    ...
    {
        int temp = readFromMemory(pw, memory_reader, SP);
